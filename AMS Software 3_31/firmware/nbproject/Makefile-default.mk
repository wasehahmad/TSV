...
SOURCEFILES_QUOTED_IF_SPACED=firmware.c adc.c i2c.c watchdog.c eeprom.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/firmware.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/watchdog.p1 ${OBJECTDIR}/eeprom.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/firmware.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/watchdog.p1.d ${OBJECTDIR}/eeprom.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/firmware.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/watchdog.p1 ${OBJECTDIR}/eeprom.p1

# Source Files
SOURCEFILES=firmware.c adc.c i2c.c watchdog.c eeprom.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"      --ram=default,-240-24f  -odist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
